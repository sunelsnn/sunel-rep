...
#
# File    : accel_unix.tmf   $Revision: 1.27.4.28 $
#
# Abstract:
...
MODEL              = neuronchainv7
MODULES            = neuronchainv7_acc_data.c 
MAKEFILE           = neuronchainv7.mk
MATLAB_ROOT        = /usr/local/MATLAB/R2010b
ALT_MATLAB_ROOT    = /usr/local/MATLAB/R2010b
MASTER_ANCHOR_DIR  = 
START_DIR          = /opt/nsl/proj4
S_FUNCTIONS        = 
S_FUNCTIONS_LIB    = 
SOLVER             = ode45.c
NUMST              = 18
...
ADD_INCLUDES = \
	-I$(START_DIR)/slprj/accel/neuronchainv7 \
	-I$(START_DIR) \
